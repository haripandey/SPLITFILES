...
//////////////////////////////////////////////////////////////
       ...
       cout<<'\n';
       cout<<BOLDRED<<"* NOTE(3):.....WARNING!!! your final file may be unwanted please check it. For example you hit for 12 files, this code will give you  ttotal 11 files. hence 11 th file may be un wanted. so open it and look its content. It may be extra."<<RESET<<endl;
...
////////////////////////////////////////////////////////////////////////////// 
       ...
       delete[]buffer;     
       //i=i+1;
       ifstream finfil(outfile.c_str());
       finfil.seekg(0,std::ios::end);
       Nsize=finfil.tellg();
       //cout<<"SIZE_ = "<<Nsize<<endl;
       cout<<BOLDCYAN<<"   Name of file generated= "<<outfile<<"  and  its  "<<RESET;cout<<BOLDBLUE<< "SIZE_ = "<<RESET<<Nsize<<endl;
       finfil.close();
...
cout<<"    CONGRATULATIONA! Your file has been splitted into  "<< number <<" parts. " <<RESET<<endl;
cout<<'\n';
cout<<BOLDRED<<"    Pleasse check  "<< number <<"th file  might be useless."<<endl;
cout<< '\n';
cout<<'\n';
return 0;
}
